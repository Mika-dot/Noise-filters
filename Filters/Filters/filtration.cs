...
namespace Filters
{
    ...
    public class filtration
    {
        public static double[] NoiseCalculation(int[] array)
        {
            ...
            {
                if ((Math.Abs(array[i] - array[i - 1]) - (noise / number2)) > (noise / number2) * 2)
                {
        ...
        public static double[] NoiseCalculation(double[] array)
        {
            double noise = 0;
            double release = 0;
            int number1 = 0;
        ...
        public static double[] StretchedSelection(double[] array)
        {
            byte counter = 0;     // счётчик
            double prevResult = 0; // хранит предыдущее готовое значение
            double sum = 0;  // сумма
            int NUM_READ = 10;
        ...
        public static double[] RunningAverage(double[] array)
        {
            ...
            int t = 0;
            double[] vals = new double[NUM_READ];
            double average = 0;
        ...
        public static double[] ExponentialRunningAverage(double[] array)
        {
            double k = 0.9;  // коэффициент фильтрации, 0.0-1.0
            double filVal = 0;
        ...
        public static double[] AdaptiveFactor(double[] array)
        {
            double filVal = 0;
        ...
        public static double[] MedianFilter(double[] array)
        {
            int NUM_READ = 10;
            double[] buffer = new double[NUM_READ];
            byte count = 0;
        ...
        public static double[] LeastSquareMethod2(double[] array)
        {
            double[] garbage = new double[3];
        ...
        public static double[] LeastSquareMethod3(double[] array)
        {
            double[] garbage = new double[4];
